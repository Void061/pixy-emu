...
async function main() {
  ...
  const testItems = [
    ...
    },
    {
      ...
      states: [{ id: "default", label: "Normale" }],
      interactionPoints: {
        ne: { approachTile: { x: -1, y: 0 }, seatOffset: { x: 0, y: -8 } },
        se: { approachTile: { x: 0, y: -1 }, seatOffset: { x: 0, y: -8 } },
        sw: { approachTile: { x: 1, y: 0 }, seatOffset: { x: 0, y: -8 } },
        nw: { approachTile: { x: 0, y: 1 }, seatOffset: { x: 0, y: -8 } },
      },
      zHeight: 25,
      spriteFormat: "png",
    },
